...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'TaskFlow'); ?> — Система управления задачами</title>
...
<aside class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-800 shadow-xl transform transition-transform duration-200 lg:translate-x-0"
    ...
    <nav class="p-3 space-y-1">
        ...
        <a href="<?php echo e(route('projects.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('projects.*') ? 'active' : ''); ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(route('tasks.index')); ?>"
           class="sidebar-link <?php echo e(request()->routeIs('tasks.*') ? 'active' : ''); ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/notes"
           class="sidebar-link <?php echo e(request()->is('notes*') ? 'active' : ''); ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="absolute bottom-0 left-0 right-0 p-3 border-t border-slate-700" x-data="{ open: false }">
        <button @click="open = !open" class="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-700 transition-all">
            ...
            <div class="flex-1 text-left">
                ...
                <div class="text-xs text-slate-400"><?php echo e(auth()->user()->getRoleNames()->first()); ?></div>
            </div>
...
<div class="lg:pl-64 min-h-screen">
    ...
    <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-30">
        ...
        <div class="flex-1 ml-4 lg:ml-0">
            <h1 class="text-lg font-semibold text-slate-800"><?php echo $__env->yieldContent('header', 'Dashboard'); ?></h1>
        </div>
